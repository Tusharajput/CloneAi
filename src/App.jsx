      ...
      <div className="sideBar">
       ...
       <div className='main'>
         <div className="chats">
             ...
             <div className="chat bot">
               <img className='chatImg' src={psyduck} alt="" /><p className="text1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi consectetur eius accusantium possimus hic provident? Praesentium distinctio incidunt nulla. Temporibus dicta, beatae ratione, delectus illum nostrum laboriosam voluptas nemo sadipisicing elit. Modi consectetur eius accPraesentium distinctio incidunt nulla. Temporibus dicta, beatae ratione, delectus illum nostrum laboriosam voluptas nemo ptas nemo suscipit voluptatibus quos consequuntur nisi similique dignissimos ut eum nesciunt fuga obcaecati mollitia velit magnam quis aliquid sed doloribus.</p>
             </div>
         </div>
